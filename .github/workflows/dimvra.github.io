...
<head>
    ...
    <title>次元行者-XP人格分类系统 | DIMVRA</title>
...
<body>
    ...
    <div class="container">
        ...
        <h1><i class="fas fa-paw"></i> 次元行者-XP人格分类系统</h1>
        ...
        <div id="result">
            ...
            <div class="type-card" id="personality-result">
    ...
    <script>
        ...
        function showResult(code) {
            ...
            // 滚动到人格类型结果区域
            setTimeout(() => {
                personalityResult.scrollIntoView({ behavior: 'smooth', block: 'start' });
            }, 300);
        }
